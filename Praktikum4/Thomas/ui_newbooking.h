...
public:
    ...
    void setupUi(QDialog *NewBooking)
    {
        if (NewBooking->objectName().isEmpty())
            NewBooking->setObjectName(QString::fromUtf8("NewBooking"));
        ...
        lblPreis->setObjectName(QString::fromUtf8("lblPreis"));
        lblPreis->setGeometry(QRect(10, 20, 47, 13));
        lblReiseID = new QLabel(NewBooking);
        lblReiseID->setObjectName(QString::fromUtf8("lblReiseID"));
    ...
    void retranslateUi(QDialog *NewBooking)
    {
        ...
        cBSmoke->setText(QString());
        cBSeat->setItemText(0, QApplication::translate("NewBooking", "A", nullptr));
        cBSeat->setItemText(1, QApplication::translate("NewBooking", "W", nullptr));
